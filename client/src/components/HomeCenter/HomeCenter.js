          ...
          <div style={{ flex: "1 1 50%", minWidth: 280 }}>
            ...
            <ul style={{ listStyle: "none", padding: 0, marginBottom: 30 }}>
              <li style={{ marginBottom: 8 }}>
                <strong>Category: </strong> {hotEvent?.event?.category || "N/A"}
              </li>
              <li style={{ marginBottom: 8 }}>
                <strong>Status: </strong> {hotEvent?.event?.status || "N/A"}
              </li>
              <li style={{ marginBottom: 8 }}>
                <strong>Start Date: </strong> {hotEvent?.event?.date || "N/A"}
              </li>
              <li>
                <strong>Sponsor: </strong>{" "}
                {hotEvent?.event?.speaker?.[0]?.name || "N/A"}
              </li>
            </ul>
            <a
